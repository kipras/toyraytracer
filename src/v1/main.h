...
// Not sure if material type is the same as reflection type, or if reflection type is a separate thing.
//
// Also, i've seen (in smallpt slides [1]) that Specular means mirror reflection.
// If so - shouldn't it then mean glass material?
// Smallpt slides also say that "glass is both reflective and refractive" [2].
//
// [1] https://docs.google.com/open?id=0B8g97JkuSSBwUENiWTJXeGtTOHFmSm51UC01YWtCZw
// [2] https://docs.google.com/presentation/d/0B8g97JkuSSBwUENiWTJXeGtTOHFmSm51UC01YWtCZw/edit?resourcekey=0-BSMES1GmPEtIIcv6EgBTjw#slide=id.p69
